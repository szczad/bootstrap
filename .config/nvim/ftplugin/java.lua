-- SRC: https://sookocheff.com/post/vim/neovim-java-ide/
local home = os.getenv('HOME')
local jdtls = require('jdtls')

local jdtls_path = home .. '/.local/jdtls/'
...
local config = {
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = "JavaSE-17",
            path = vim.fn.glob(sdkman_candidates .. "17.*-tem")
          },
          {
            name = "JavaSE-11",
            path = vim.fn.glob(sdkman_candidates .. "11.*-tem")
          },
          {
            name = "JavaSE-1.8",
            path = vim.fn.glob(sdkman_candidates .. "8.*-tem")
          },
        }
      }
    }
  ...
  cmd = {
    vim.fn.glob(sdkman_candidates .. "17.*-tem/bin/java"),
